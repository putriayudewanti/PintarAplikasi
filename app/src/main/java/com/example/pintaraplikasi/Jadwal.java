...
public class Jadwal extends Alarm  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageViewStart=(ImageView) findViewById(R.id.btSet );
        ImageViewStart=(ImageView) findViewById(R.id.btSett );
        ImageViewStart=(ImageView) findViewById(R.id.bttSett );
        ImageViewStart=(ImageView) findViewById(R.id.bbtSett );
        ImageViewStart=(ImageView) findViewById(R.id.btSsett );
    ...
    public void next(View view) {
        Intent intent = new Intent(Jadwal.this, Doaharian.class);
        startActivity(intent);
    }

    public void log(View view) {
        Intent intent = new Intent(Jadwal.this, Zikir.class);
        startActivity(intent);
    }
